/*
QuickSort is a Divide and Conquer algorithm. It picks an element as pivot and partitions the given array around the picked pivot(in case of lomuto partition).
...
function lomuto_partition(arr, low, high) {
  ...
  while (i < j) {
    do {
      // All elements i.e LHS<Pivot
      i++;
    } while (arr[i] < arr[pivot]);

    do {
      // All elements i.e RHS>pivot
      j--;
